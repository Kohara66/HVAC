...
public class HVAC {
    ...
    private static void addServiceCall() {
        ...
        System.out.println("3. Add service call for WaterHeater");
        ...
        switch (choice) {
            ...
            case 3: {
                System.out.println("Enter address of WaterHeater");
                String address = getStringInput();
                System.out.println("Enter description of problem");
                String problem = getStringInput();
                System.out.println("Enter age of WaterHeater");
                int age = Integer.parseInt(getStringInput());
